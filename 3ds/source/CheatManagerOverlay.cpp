...
CheatManagerOverlay::CheatManagerOverlay(Screen& screen, const std::string& mkey) : Overlay(screen)
{
    ...
    C2D_TextParse(&multiSelectText, staticBuf, "\uE003 pour sélectionner toutes les triches");
    C2D_TextParse(&multiDeselectText, staticBuf, "\uE003 pour désélectionner toutes les triches");
